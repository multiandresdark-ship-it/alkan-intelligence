...
1. Publish the verified console to the authorized hosting provider and verify its public login.
2. Use an existing Supabase Auth account and assign it to the intended client workspace. No access grant or invitation has been invented.
...
5. Load the agreed real pilot contacts. No sample prospects or funded outcomes are seeded.
